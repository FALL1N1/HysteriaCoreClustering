...
void WorldSession::HandleBattlemasterJoinOpcode(WorldPacket & recvData)
{
    ...
    {
        ChatHandler(this).PSendSysMessage("You can queue for battleground only in capital cities (master node) for now.");
        ChatHandler(this).PSendSysMessage("If you leave the city you will be automatically removed from the bg pool.");
        return;
    }
        ...
        case 1: // accept
            {
                ...
                if (sWorld->getBoolConfig(CONFIG_REPLACE_5V5_ARENA))
...
void WorldSession::HandleBattlemasterJoinArena(WorldPacket & recvData)
{
    if (sWorld->getIntConfig(CONFIG_CORE_TYPE) != NODE_TYPE_MASTER)
    {
        ChatHandler(this).PSendSysMessage("You can queue for arena only in capital cities (master node) for now.");
        ChatHandler(this).PSendSysMessage("If you leave the city you will be automatically removed from the arena pool.");
        return;
    }
