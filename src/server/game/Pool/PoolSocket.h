...
typedef ACE_Svc_Handler<ACE_SOCK_STREAM, ACE_NULL_SYNCH> PoolHandler;
 ...
 *
 * The calls to Update() method are managed by PoolSocketMgr
 * and ReactorRunnable.
 *
 ...
 *
 */
class PoolSocket : public WorldHandler
{
    public:
        PoolSocket (void);
        virtual ~PoolSocket (void);
        ...
        int SendPacketToLogon(const WorldPacket& pct);
        ...
        /// Called by PoolSocketMgr/ReactorRunnable.
        int Update (void);
