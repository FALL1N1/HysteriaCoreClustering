...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        ////////////////////Cluster System/////////////////////
        void C_UpdateAllStats(); // todo
        void C_SetHealth(uint32 val);
        void C_SetMaxHealth(uint32 val);
        void C_SetPower(uint32 val);
        void C_SetMaxPower(uint32 val);
        void C_SetPowerType(Powers power);
        void C_UpdateFlags(bool status, uint32 flag); 
        void C_setDeathState(DeathState s);
        void C_UpdatePosition(float x, float y, float z, float o, bool tele);
        void C_SendGuildId(uint32 id);
        ...
        uint32 api_damageDone, api_healingDone, api_deaths = 0;
        std::string LootedItem1, LootedItem2, LootedItem3, LootedItem4, LootedItem5 = "";
        ...
        void PerformNodeChangeStuff(std::string x = "");
