...
void Spell::SelectImplicitCasterDestTargets(SpellEffIndex effIndex, SpellImplicitTargetInfo const& targetType)
{
    ...
    switch (targetType.GetTarget())
    {
        ...
        case TARGET_DEST_CASTER_FISHING:
        {
            ...
            m_caster->GetNearPoint(m_caster, x, y, z, DEFAULT_WORLD_OBJECT_SIZE, dist, m_caster->GetOrientation() + angle);
...
void Spell::AddUnitTarget(Unit* target, uint32 effectMask, bool checkIfValid /*= true*/, bool implicit /*= true*/)
{
    ...
    if (targetInfo.missCondition == SPELL_MISS_REFLECT)
    {
        ...
        // @emo hackfix spell reflect and shield wall
        if(m_caster->HasAura(123))
            targetInfo.damage = targetInfo.damage * 0.60;
...
void Spell::prepare(SpellCastTargets const* targets, AuraEffect const* triggeredByAura)
{
    ...
    if (Player* player = m_caster->ToPlayer())
    {
        ...
        {
            pet->UpdateSpeed(MOVE_WALK, true);
        ...
        m_casttime = m_spellInfo->CalcCastTime();
