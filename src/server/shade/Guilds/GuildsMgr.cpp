...
void GuildMgr::LoadGuilds()
{
    ...
    sLog->outString("Loading guild event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute("DELETE FROM guild_eventlog WHERE LogGuid > %u", GUILD_EVENTLOG_MAX_RECORDS);
    ...
    sLog->outString("Loading guild bank event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute("DELETE FROM guild_bank_eventlog WHERE LogGuid > %u", GUILD_BANKLOG_MAX_RECORDS);
